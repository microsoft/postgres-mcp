...
- **Changelog:** [GitHub Releases](https://github.com/microsoft/pgsql-tools/releases?q=mcp)
...
Licensed under the [MIT License](https://github.com/microsoft/pgsql-tools/blob/main/LICENSE) © Microsoft.
